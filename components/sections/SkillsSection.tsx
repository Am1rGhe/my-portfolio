    ...
    >
      ...
      >
        <div className="p-8 md:p-12">
          ...
          {/* Tab navbar */}
          <div className="flex flex-wrap justify-center gap-2 mb-8 pb-4 border-b border-slate-600/50">
          ...
          <div className="relative overflow-hidden">
            ...
            >
              ...
              {[...(activeCategory?.skills ?? []), ...(activeCategory?.skills ?? [])].map((skill, index) => (
                ...
                >
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-xl bg-slate-800/80 border border-slate-600/50 flex items-center justify-center p-4 transition-all duration-300 group-hover:scale-110 group-hover:border-sky-500/50 group-hover:shadow-[0_0_25px_rgba(56,189,248,0.2)]">
